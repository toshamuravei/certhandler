...
CONTAINER_NAME := certhandler

PROD_IMAGE := certhandler:alpine_prod
DEV_IMAGE := certhandler:alpine_dev
IMAGE := $(PROD_IMAGE)
SAVE_IMAGE_FILE := certhandler_local_image_alpine_prod.tar.gz
